...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pruebas_____grid_sicloud"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pruebas_____grid_sicloud"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_sicloud']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_sicloud']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_sicloud']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_sicloud']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_sicloud']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_sicloud']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_sicloud']['embutida_filho'] as $ind => $sc_init)
          {
