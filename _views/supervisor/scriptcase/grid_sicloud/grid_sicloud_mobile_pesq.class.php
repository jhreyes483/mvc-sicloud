...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "f_fecha";$Nm_numeric[] = "f_total";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_p_nom_prod"  <?php echo $str_hide_p_nom_prod?>><?php
      $p_nom_prod_look = substr($this->Db->qstr($p_nom_prod), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_u_id_us"  <?php echo $str_hide_u_id_us?>><?php
      $u_id_us_look = substr($this->Db->qstr($u_id_us), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_u_nom1"  <?php echo $str_hide_u_nom1?>><?php
      $u_nom1_look = substr($this->Db->qstr($u_nom1), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_u_ape1"  <?php echo $str_hide_u_ape1?>><?php
      $u_ape1_look = substr($this->Db->qstr($u_ape1), 1, -1); 
      $nmgp_def_dados = array(); 
