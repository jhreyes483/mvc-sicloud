...
class grid_sicloud_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_sicloud_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_sicloud_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_sicloud_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_p_nom_prod')
      {
          $p_nom_prod = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_p_nom_prod($p_nom_prod);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_u_id_us')
      {
          $u_id_us = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_u_id_us($u_id_us);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
      ...
      if ($this->NM_ajax_opcao == 'autocomp_u_nom1')
      {
          $u_nom1 = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_u_nom1($u_nom1);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
      ...
      if ($this->NM_ajax_opcao == 'autocomp_u_ape1')
      {
          $u_ape1 = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_u_ape1($u_ape1);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
   ...
   function lookup_ajax_p_nom_prod($p_nom_prod)
   {
      $p_nom_prod = substr($this->Db->qstr($p_nom_prod), 1, -1);
            $p_nom_prod_look = substr($this->Db->qstr($p_nom_prod), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct p.nom_prod from " . $this->Ini->nm_tabela . " where  p.nom_prod like '%" . $p_nom_prod . "%'"; 
   ...
   function lookup_ajax_u_id_us($u_id_us)
   {
      $u_id_us = substr($this->Db->qstr($u_id_us), 1, -1);
            $u_id_us_look = substr($this->Db->qstr($u_id_us), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct u.ID_us from " . $this->Ini->nm_tabela . " where  u.ID_us like '%" . $u_id_us . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_u_nom1($u_nom1)
   {
      $u_nom1 = substr($this->Db->qstr($u_nom1), 1, -1);
            $u_nom1_look = substr($this->Db->qstr($u_nom1), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct u.nom1 from " . $this->Ini->nm_tabela . " where  u.nom1 like '%" . $u_nom1 . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_u_ape1($u_ape1)
   {
      $u_ape1 = substr($this->Db->qstr($u_ape1), 1, -1);
            $u_ape1_look = substr($this->Db->qstr($u_ape1), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct u.ape1 from " . $this->Ini->nm_tabela . " where  u.ape1 like '%" . $u_ape1 . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_sicloud/grid_sicloud_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_sicloud_ajax_search.js"></script>
 <script type="text/javascript" src="grid_sicloud_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_p_nom_prod_cond#NMF#' + search_get_sel_txt('SC_p_nom_prod_cond') + '@NMF@';
  str_out += 'SC_p_nom_prod#NMF#' + search_get_text('SC_p_nom_prod') + '@NMF@';
  str_out += 'id_ac_p_nom_prod#NMF#' + search_get_text('id_ac_p_nom_prod') + '@NMF@';
  str_out += 'SC_u_id_us_cond#NMF#' + search_get_sel_txt('SC_u_id_us_cond') + '@NMF@';
  str_out += 'SC_u_id_us#NMF#' + search_get_text('SC_u_id_us') + '@NMF@';
  str_out += 'id_ac_u_id_us#NMF#' + search_get_text('id_ac_u_id_us') + '@NMF@';
  str_out += 'SC_u_nom1_cond#NMF#' + search_get_sel_txt('SC_u_nom1_cond') + '@NMF@';
  str_out += 'SC_u_nom1#NMF#' + search_get_text('SC_u_nom1') + '@NMF@';
  str_out += 'id_ac_u_nom1#NMF#' + search_get_text('id_ac_u_nom1') + '@NMF@';
  str_out += 'SC_u_ape1_cond#NMF#' + search_get_sel_txt('SC_u_ape1_cond') + '@NMF@';
  str_out += 'SC_u_ape1#NMF#' + search_get_text('SC_u_ape1') + '@NMF@';
  str_out += 'id_ac_u_ape1#NMF#' + search_get_text('id_ac_u_ape1') + '@NMF@';
   ...
   $("#id_ac_u_id_us").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_u_id_us",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_u_id_us").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_u_id_us").val( $(this).val() );
       }
     }
   });
   $("#id_ac_u_nom1").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_u_nom1",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_u_nom1").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_u_nom1").val( $(this).val() );
       }
     }
   });
   $("#id_ac_u_ape1").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_u_ape1",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_u_ape1").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_u_ape1").val( $(this).val() );
       }
     }
   });
   $("#id_ac_p_nom_prod").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_p_nom_prod",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_p_nom_prod").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_p_nom_prod").val( $(this).val() );
       }
     }
   });
 });
...
<?php
   ...
   {
      global 
             $p_nom_prod_cond, $p_nom_prod, $p_nom_prod_autocomp,
             $u_id_us_cond, $u_id_us, $u_id_us_autocomp,
             $u_nom1_cond, $u_nom1, $u_nom1_autocomp,
             $u_ape1_cond, $u_ape1, $u_ape1_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $p_nom_prod = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['campos_busca']['p_nom_prod']; 
          $p_nom_prod_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['campos_busca']['p_nom_prod_cond']; 
          $u_id_us = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['campos_busca']['u_id_us']; 
          $u_id_us_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['campos_busca']['u_id_us_cond']; 
          $u_nom1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['campos_busca']['u_nom1']; 
          $u_nom1_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['campos_busca']['u_nom1_cond']; 
          $u_ape1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['campos_busca']['u_ape1']; 
          $u_ape1_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['campos_busca']['u_ape1_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['campos_busca']['NM_operador']; 
      } 
      if (!isset($p_nom_prod_cond) || empty($p_nom_prod_cond))
      {
         $p_nom_prod_cond = "qp";
      }
      if (!isset($u_id_us_cond) || empty($u_id_us_cond))
      {
         $u_id_us_cond = "qp";
      }
      if (!isset($u_nom1_cond) || empty($u_nom1_cond))
      {
         $u_nom1_cond = "qp";
      }
      if (!isset($u_ape1_cond) || empty($u_ape1_cond))
      {
         $u_ape1_cond = "qp";
      }
      ...
      $str_hide_p_nom_prod = (in_array($p_nom_prod_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_u_id_us = (in_array($u_id_us_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_u_nom1 = (in_array($u_nom1_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_u_ape1 = (in_array($u_ape1_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($p_nom_prod) || $p_nom_prod == "")
      {
          $p_nom_prod = "";
      }
      if (isset($p_nom_prod) && !empty($p_nom_prod))
      {
         $tmp_pos = strpos($p_nom_prod, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $p_nom_prod = substr($p_nom_prod, 0, $tmp_pos);
         }
      }
      if (!isset($u_id_us) || $u_id_us == "")
      {
          $u_id_us = "";
      }
      if (isset($u_id_us) && !empty($u_id_us))
      {
         $tmp_pos = strpos($u_id_us, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $u_id_us = substr($u_id_us, 0, $tmp_pos);
         }
      }
      if (!isset($u_nom1) || $u_nom1 == "")
      {
          $u_nom1 = "";
      }
      if (isset($u_nom1) && !empty($u_nom1))
      {
         $tmp_pos = strpos($u_nom1, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $u_nom1 = substr($u_nom1, 0, $tmp_pos);
         }
      }
      if (!isset($u_ape1) || $u_ape1 == "")
      {
          $u_ape1 = "";
      }
      if (isset($u_ape1) && !empty($u_ape1))
      {
         $tmp_pos = strpos($u_ape1, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $u_ape1 = substr($u_ape1, 0, $tmp_pos);
         }
      }
?>
 <?php
...
<?php
   if (is_file("grid_sicloud_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['p_nom_prod'])) ? $this->New_label['p_nom_prod'] : "Nom Prod"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_p_nom_prod_cond" name="p_nom_prod_cond" onChange="nm_campos_between(document.getElementById('id_vis_p_nom_prod'), this, 'p_nom_prod')">
       <OPTION value="qp" <?php if ("qp" == $p_nom_prod_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $p_nom_prod_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $p_nom_prod_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $p_nom_prod_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_p_nom_prod" <?php echo $str_hide_p_nom_prod?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['p_nom_prod'])) ? $this->New_label['p_nom_prod'] : "Nom Prod";
 $nmgp_tab_label .= "p_nom_prod?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $p_nom_prod_look = substr($this->Db->qstr($p_nom_prod), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct p.nom_prod from " . $this->Ini->nm_tabela . " where p.nom_prod = '$p_nom_prod_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$p_nom_prod]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$p_nom_prod];
      }
      else
      {
          $sAutocompValue = $p_nom_prod;
      }
?>
<INPUT  type="text" id="SC_p_nom_prod" name="p_nom_prod" value="<?php echo NM_encode_input($p_nom_prod) ?>" size=50 alt="{datatype: 'text', maxLength: 90, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_p_nom_prod" name="p_nom_prod_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['u_id_us'])) ? $this->New_label['u_id_us'] : "ID Us"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_u_id_us_cond" name="u_id_us_cond" onChange="nm_campos_between(document.getElementById('id_vis_u_id_us'), this, 'u_id_us')">
       <OPTION value="qp" <?php if ("qp" == $u_id_us_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $u_id_us_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $u_id_us_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $u_id_us_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_u_id_us" <?php echo $str_hide_u_id_us?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['u_id_us'])) ? $this->New_label['u_id_us'] : "ID Us";
 $nmgp_tab_label .= "u_id_us?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $u_id_us_look = substr($this->Db->qstr($u_id_us), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct u.ID_us from " . $this->Ini->nm_tabela . " where u.ID_us = '$u_id_us_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$u_id_us]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$u_id_us];
      }
      else
      {
          $sAutocompValue = $u_id_us;
      }
?>
<INPUT  type="text" id="SC_u_id_us" name="u_id_us" value="<?php echo NM_encode_input($u_id_us) ?>" size=50 alt="{datatype: 'text', maxLength: 75, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_u_id_us" name="u_id_us_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['u_nom1'])) ? $this->New_label['u_nom1'] : "Nom 1"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_u_nom1_cond" name="u_nom1_cond" onChange="nm_campos_between(document.getElementById('id_vis_u_nom1'), this, 'u_nom1')">
       <OPTION value="qp" <?php if ("qp" == $u_nom1_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $u_nom1_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $u_nom1_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $u_nom1_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_u_nom1" <?php echo $str_hide_u_nom1?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['u_nom1'])) ? $this->New_label['u_nom1'] : "Nom 1";
 $nmgp_tab_label .= "u_nom1?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $u_nom1_look = substr($this->Db->qstr($u_nom1), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct u.nom1 from " . $this->Ini->nm_tabela . " where u.nom1 = '$u_nom1_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$u_nom1]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$u_nom1];
      }
      else
      {
          $sAutocompValue = $u_nom1;
      }
?>
<INPUT  type="text" id="SC_u_nom1" name="u_nom1" value="<?php echo NM_encode_input($u_nom1) ?>" size=50 alt="{datatype: 'text', maxLength: 60, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_u_nom1" name="u_nom1_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['u_ape1'])) ? $this->New_label['u_ape1'] : "Ape 1"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_u_ape1_cond" name="u_ape1_cond" onChange="nm_campos_between(document.getElementById('id_vis_u_ape1'), this, 'u_ape1')">
       <OPTION value="qp" <?php if ("qp" == $u_ape1_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $u_ape1_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $u_ape1_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $u_ape1_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_u_ape1" <?php echo $str_hide_u_ape1?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['u_ape1'])) ? $this->New_label['u_ape1'] : "Ape 1";
 $nmgp_tab_label .= "u_ape1?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $u_ape1_look = substr($this->Db->qstr($u_ape1), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct u.ape1 from " . $this->Ini->nm_tabela . " where u.ape1 = '$u_ape1_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$u_ape1]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$u_ape1];
      }
      else
      {
          $sAutocompValue = $u_ape1;
      }
?>
<INPUT  type="text" id="SC_u_ape1" name="u_ape1" value="<?php echo NM_encode_input($u_ape1) ?>" size=50 alt="{datatype: 'text', maxLength: 60, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_u_ape1" name="u_ape1_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_sicloud']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_sicloud']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_p_nom_prod'), document.F1.p_nom_prod_cond, 'p_nom_prod');
   document.F1.p_nom_prod.value = "";
   document.F1.p_nom_prod_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_u_id_us'), document.F1.u_id_us_cond, 'u_id_us');
   document.F1.u_id_us.value = "";
   document.F1.u_id_us_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_u_nom1'), document.F1.u_nom1_cond, 'u_nom1');
   document.F1.u_nom1.value = "";
   document.F1.u_nom1_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_u_ape1'), document.F1.u_ape1_cond, 'u_ape1');
   document.F1.u_ape1.value = "";
   document.F1.u_ape1_autocomp.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_p_nom_prod_cond'] = 'cond';
      $tp_fields['SC_p_nom_prod'] = 'text_aut';
      $tp_fields['id_ac_p_nom_prod'] = 'text_aut';
      $tp_fields['SC_u_id_us_cond'] = 'cond';
      $tp_fields['SC_u_id_us'] = 'text_aut';
      $tp_fields['id_ac_u_id_us'] = 'text_aut';
      $tp_fields['SC_u_nom1_cond'] = 'cond';
      $tp_fields['SC_u_nom1'] = 'text_aut';
      $tp_fields['id_ac_u_nom1'] = 'text_aut';
      $tp_fields['SC_u_ape1_cond'] = 'cond';
      $tp_fields['SC_u_ape1'] = 'text_aut';
      $tp_fields['id_ac_u_ape1'] = 'text_aut';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $p_nom_prod_cond, $p_nom_prod, $p_nom_prod_autocomp,
             $u_id_us_cond, $u_id_us, $u_id_us_autocomp,
             $u_nom1_cond, $u_nom1, $u_nom1_autocomp,
             $u_ape1_cond, $u_ape1, $u_ape1_autocomp, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($p_nom_prod_autocomp) && empty($p_nom_prod))
      {
          $p_nom_prod = $p_nom_prod_autocomp;
      }
      if (!empty($u_id_us_autocomp) && empty($u_id_us))
      {
          $u_id_us = $u_id_us_autocomp;
      }
      if (!empty($u_nom1_autocomp) && empty($u_nom1))
      {
          $u_nom1 = $u_nom1_autocomp;
      }
      if (!empty($u_ape1_autocomp) && empty($u_ape1))
      {
          $u_ape1 = $u_ape1_autocomp;
      }
      $p_nom_prod_cond_salva = $p_nom_prod_cond; 
      if (!isset($p_nom_prod_input_2) || $p_nom_prod_input_2 == "")
      {
          $p_nom_prod_input_2 = $p_nom_prod;
      }
      $u_id_us_cond_salva = $u_id_us_cond; 
      if (!isset($u_id_us_input_2) || $u_id_us_input_2 == "")
      {
          $u_id_us_input_2 = $u_id_us;
      }
      $u_nom1_cond_salva = $u_nom1_cond; 
      if (!isset($u_nom1_input_2) || $u_nom1_input_2 == "")
      {
          $u_nom1_input_2 = $u_nom1;
      }
      $u_ape1_cond_salva = $u_ape1_cond; 
      if (!isset($u_ape1_input_2) || $u_ape1_input_2 == "")
      {
          $u_ape1_input_2 = $u_ape1;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['campos_busca']['p_nom_prod'] = $p_nom_prod; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['campos_busca']['p_nom_prod_cond'] = $p_nom_prod_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['campos_busca']['u_id_us'] = $u_id_us; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['campos_busca']['u_id_us_cond'] = $u_id_us_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['campos_busca']['u_nom1'] = $u_nom1; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['campos_busca']['u_nom1_cond'] = $u_nom1_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['campos_busca']['u_ape1'] = $u_ape1; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['campos_busca']['u_ape1_cond'] = $u_ape1_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['p_nom_prod'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['p_nom_prod'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['p_nom_prod'] = $p_nom_prod;
      }
      $u_id_us_look = substr($this->Db->qstr($u_id_us), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct u.ID_us from " . $this->Ini->nm_tabela . " where u.ID_us = '$u_id_us_look'"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['u_id_us'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['u_id_us'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['u_id_us'] = $u_id_us;
      }
      $u_nom1_look = substr($this->Db->qstr($u_nom1), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct u.nom1 from " . $this->Ini->nm_tabela . " where u.nom1 = '$u_nom1_look'"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['u_nom1'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['u_nom1'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['u_nom1'] = $u_nom1;
      }
      $u_ape1_look = substr($this->Db->qstr($u_ape1), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct u.ape1 from " . $this->Ini->nm_tabela . " where u.ape1 = '$u_ape1_look'"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['u_ape1'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['u_ape1'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['u_ape1'] = $u_ape1;
      }

      //----- $p_nom_prod
      $this->Date_part = false;
      if (isset($p_nom_prod) || $p_nom_prod_cond == "nu" || $p_nom_prod_cond == "nn" || $p_nom_prod_cond == "ep" || $p_nom_prod_cond == "ne")
      {
         $this->monta_condicao("p.nom_prod", $p_nom_prod_cond, $p_nom_prod, "", "p_nom_prod");
      }

      //----- $u_id_us
      $this->Date_part = false;
      if (isset($u_id_us) || $u_id_us_cond == "nu" || $u_id_us_cond == "nn" || $u_id_us_cond == "ep" || $u_id_us_cond == "ne")
      {
         $this->monta_condicao("u.ID_us", $u_id_us_cond, $u_id_us, "", "u_id_us");
      }

      //----- $u_nom1
      $this->Date_part = false;
      if (isset($u_nom1) || $u_nom1_cond == "nu" || $u_nom1_cond == "nn" || $u_nom1_cond == "ep" || $u_nom1_cond == "ne")
      {
         $this->monta_condicao("u.nom1", $u_nom1_cond, $u_nom1, "", "u_nom1");
      }

      //----- $u_ape1
      $this->Date_part = false;
      if (isset($u_ape1) || $u_ape1_cond == "nu" || $u_ape1_cond == "nn" || $u_ape1_cond == "ep" || $u_ape1_cond == "ne")
      {
         $this->monta_condicao("u.ape1", $u_ape1_cond, $u_ape1, "", "u_ape1");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sicloud']['where_pesq_ant'] = $this->comando . $this->comando_fim;
