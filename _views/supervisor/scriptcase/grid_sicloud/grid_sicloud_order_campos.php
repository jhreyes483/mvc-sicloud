<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_sicloud_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_sicloud_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['u_id_us'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['u_id_us'] = "u_id_us";
       $tab_converte["u_id_us"]   = "u_id_us";
   }
   else
   {
       $tab_def_campos['u_id_us'] = "u.ID_us";
       $tab_converte["u.ID_us"]   = "u_id_us";
   }
   $tab_labels["u_id_us"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sicloud']['labels']["u_id_us"])) ? $_SESSION['sc_session'][$sc_init]['grid_sicloud']['labels']["u_id_us"] : "ID Us";
   $tab_ger_campos['u_nom1'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['u_nom1'] = "u_nom1";
       $tab_converte["u_nom1"]   = "u_nom1";
   }
   else
   {
       $tab_def_campos['u_nom1'] = "u.nom1";
       $tab_converte["u.nom1"]   = "u_nom1";
   }
   $tab_labels["u_nom1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sicloud']['labels']["u_nom1"])) ? $_SESSION['sc_session'][$sc_init]['grid_sicloud']['labels']["u_nom1"] : "Nom 1";
   $tab_ger_campos['u_ape1'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['u_ape1'] = "u_ape1";
       $tab_converte["u_ape1"]   = "u_ape1";
   }
   else
   {
       $tab_def_campos['u_ape1'] = "u.ape1";
       $tab_converte["u.ape1"]   = "u_ape1";
   }
   $tab_labels["u_ape1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sicloud']['labels']["u_ape1"])) ? $_SESSION['sc_session'][$sc_init]['grid_sicloud']['labels']["u_ape1"] : "Ape 1";
   $tab_ger_campos['p_nom_prod'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['p_nom_prod'] = "p_nom_prod";
       $tab_converte["p_nom_prod"]   = "p_nom_prod";
   }
   else
   {
       $tab_def_campos['p_nom_prod'] = "p.nom_prod";
       $tab_converte["p.nom_prod"]   = "p_nom_prod";
   }
   $tab_labels["p_nom_prod"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sicloud']['labels']["p_nom_prod"])) ? $_SESSION['sc_session'][$sc_init]['grid_sicloud']['labels']["p_nom_prod"] : "Nom Prod";
   $tab_ger_campos['f_fecha'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['f_fecha'] = "f_fecha";
       $tab_converte["f_fecha"]   = "f_fecha";
   }
   else
   {
       $tab_def_campos['f_fecha'] = "f.fecha";
       $tab_converte["f.fecha"]   = "f_fecha";
   }
   $tab_labels["f_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sicloud']['labels']["f_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_sicloud']['labels']["f_fecha"] : "Fecha";
   $tab_ger_campos['tp_nom_tipo_pago'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tp_nom_tipo_pago'] = "tp_nom_tipo_pago";
       $tab_converte["tp_nom_tipo_pago"]   = "tp_nom_tipo_pago";
   }
   else
   {
       $tab_def_campos['tp_nom_tipo_pago'] = "tp.nom_tipo_pago";
       $tab_converte["tp.nom_tipo_pago"]   = "tp_nom_tipo_pago";
   }
   $tab_labels["tp_nom_tipo_pago"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sicloud']['labels']["tp_nom_tipo_pago"])) ? $_SESSION['sc_session'][$sc_init]['grid_sicloud']['labels']["tp_nom_tipo_pago"] : "Nom Tipo Pago";
   $tab_ger_campos['f_total'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['f_total'] = "f_total";
       $tab_converte["f_total"]   = "f_total";
   }
   else
   {
       $tab_def_campos['f_total'] = "f.total";
       $tab_converte["f.total"]   = "f_total";
   }
   $tab_labels["f_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sicloud']['labels']["f_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_sicloud']['labels']["f_total"] : "Total";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_sicloud']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_sicloud']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_sicloud']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_sicloud']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_sicloud']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_sicloud']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_sicloud']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_sicloud']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_sicloud']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_sicloud_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_sicloud']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_sicloud']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
