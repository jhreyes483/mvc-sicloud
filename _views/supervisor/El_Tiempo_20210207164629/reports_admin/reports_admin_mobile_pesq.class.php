...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "dc_fech_nacimiento";$Nm_datas[] = "dc_fecha_registro";$Nm_datas[] = "ds_fecha_venta";$Nm_datas[] = "ds_fecha_ini_suscripcion";$Nm_datas[] = "ds_fecha_autoriza";$Nm_datas[] = "fp_vencimiento_tc";$Nm_numeric[] = "dc_celular_clie";$Nm_numeric[] = "fp_num_tc";$Nm_numeric[] = "fp_num_cuotastc";$Nm_numeric[] = "fp_precio_bruto";$Nm_numeric[] = "fp_descuento";$Nm_numeric[] = "fp_valor_neto";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_dc_medio_contact"  <?php echo $str_hide_dc_medio_contact?>><?php
      $dc_medio_contact_look = substr($this->Db->qstr($dc_medio_contact), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_dc_tipo_cliente"  <?php echo $str_hide_dc_tipo_cliente?>><?php
      $dc_tipo_cliente_look = substr($this->Db->qstr($dc_tipo_cliente), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_dc_nombre_clie"  <?php echo $str_hide_dc_nombre_clie?>><?php
      $dc_nombre_clie_look = substr($this->Db->qstr($dc_nombre_clie), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_dc_num_documento"  <?php echo $str_hide_dc_num_documento?>><?php
      $dc_num_documento_look = substr($this->Db->qstr($dc_num_documento), 1, -1); 
      $nmgp_def_dados = array(); 
