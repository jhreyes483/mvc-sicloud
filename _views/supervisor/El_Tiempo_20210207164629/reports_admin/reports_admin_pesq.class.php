...
class reports_admin_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . reports_admin_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . reports_admin_pack_protect_string($Tipo_filter[0]) . "\">.." . reports_admin_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_dc_medio_contact')
      {
          $dc_medio_contact = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_dc_medio_contact($dc_medio_contact);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_dc_tipo_cliente')
      {
          $dc_tipo_cliente = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_dc_tipo_cliente($dc_tipo_cliente);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
      ...
      if ($this->NM_ajax_opcao == 'autocomp_dc_nombre_clie')
      {
          $dc_nombre_clie = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_dc_nombre_clie($dc_nombre_clie);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
      ...
      if ($this->NM_ajax_opcao == 'autocomp_dc_num_documento')
      {
          $dc_num_documento = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_dc_num_documento($dc_num_documento);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
   ...
   function lookup_ajax_dc_medio_contact($dc_medio_contact)
   {
      $dc_medio_contact = substr($this->Db->qstr($dc_medio_contact), 1, -1);
            $dc_medio_contact_look = substr($this->Db->qstr($dc_medio_contact), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct dc.medio_contact from " . $this->Ini->nm_tabela . " where  dc.medio_contact like '%" . $dc_medio_contact . "%'"; 
   ...
   function lookup_ajax_dc_tipo_cliente($dc_tipo_cliente)
   {
      $dc_tipo_cliente = substr($this->Db->qstr($dc_tipo_cliente), 1, -1);
            $dc_tipo_cliente_look = substr($this->Db->qstr($dc_tipo_cliente), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct dc.tipo_cliente from " . $this->Ini->nm_tabela . " where  dc.tipo_cliente like '%" . $dc_tipo_cliente . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_dc_nombre_clie($dc_nombre_clie)
   {
      $dc_nombre_clie = substr($this->Db->qstr($dc_nombre_clie), 1, -1);
            $dc_nombre_clie_look = substr($this->Db->qstr($dc_nombre_clie), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct dc.nombre_clie from " . $this->Ini->nm_tabela . " where  dc.nombre_clie like '%" . $dc_nombre_clie . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_dc_num_documento($dc_num_documento)
   {
      $dc_num_documento = substr($this->Db->qstr($dc_num_documento), 1, -1);
            $dc_num_documento_look = substr($this->Db->qstr($dc_num_documento), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct dc.num_documento from " . $this->Ini->nm_tabela . " where  dc.num_documento like '%" . $dc_num_documento . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $Nm_datas[] = "dc_fech_nacimiento";$Nm_datas[] = "dc_fecha_registro";$Nm_datas[] = "ds_fecha_venta";$Nm_datas[] = "ds_fecha_ini_suscripcion";$Nm_datas[] = "ds_fecha_autoriza";$Nm_datas[] = "fp_vencimiento_tc";
      $campo_join = strtolower(str_replace(".", "_", $nome));
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>reports_admin/reports_admin_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="reports_admin_ajax_search.js"></script>
 <script type="text/javascript" src="reports_admin_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_dc_medio_contact_cond#NMF#' + search_get_sel_txt('SC_dc_medio_contact_cond') + '@NMF@';
  str_out += 'SC_dc_medio_contact#NMF#' + search_get_text('SC_dc_medio_contact') + '@NMF@';
  str_out += 'id_ac_dc_medio_contact#NMF#' + search_get_text('id_ac_dc_medio_contact') + '@NMF@';
  str_out += 'SC_dc_tipo_cliente_cond#NMF#' + search_get_sel_txt('SC_dc_tipo_cliente_cond') + '@NMF@';
  str_out += 'SC_dc_tipo_cliente#NMF#' + search_get_text('SC_dc_tipo_cliente') + '@NMF@';
  str_out += 'id_ac_dc_tipo_cliente#NMF#' + search_get_text('id_ac_dc_tipo_cliente') + '@NMF@';
  str_out += 'SC_dc_nombre_clie_cond#NMF#' + search_get_sel_txt('SC_dc_nombre_clie_cond') + '@NMF@';
  str_out += 'SC_dc_nombre_clie#NMF#' + search_get_text('SC_dc_nombre_clie') + '@NMF@';
  str_out += 'id_ac_dc_nombre_clie#NMF#' + search_get_text('id_ac_dc_nombre_clie') + '@NMF@';
  str_out += 'SC_dc_num_documento_cond#NMF#' + search_get_sel_txt('SC_dc_num_documento_cond') + '@NMF@';
  str_out += 'SC_dc_num_documento#NMF#' + search_get_text('SC_dc_num_documento') + '@NMF@';
  str_out += 'id_ac_dc_num_documento#NMF#' + search_get_text('id_ac_dc_num_documento') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   $("#id_ac_dc_nombre_clie").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_dc_nombre_clie",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_dc_nombre_clie").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_dc_nombre_clie").val( $(this).val() );
       }
     }
   });
   $("#id_ac_dc_num_documento").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_dc_num_documento",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_dc_num_documento").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_dc_num_documento").val( $(this).val() );
       }
     }
   });
   $("#id_ac_dc_tipo_cliente").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_dc_tipo_cliente",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_dc_tipo_cliente").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_dc_tipo_cliente").val( $(this).val() );
       }
     }
   });
   $("#id_ac_dc_medio_contact").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_dc_medio_contact",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_dc_medio_contact").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_dc_medio_contact").val( $(this).val() );
       }
     }
   });
 });
...
<?php
   ...
   {
      global 
             $dc_medio_contact_cond, $dc_medio_contact, $dc_medio_contact_autocomp,
             $dc_tipo_cliente_cond, $dc_tipo_cliente, $dc_tipo_cliente_autocomp,
             $dc_nombre_clie_cond, $dc_nombre_clie, $dc_nombre_clie_autocomp,
             $dc_num_documento_cond, $dc_num_documento, $dc_num_documento_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $dc_medio_contact = $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['campos_busca']['dc_medio_contact']; 
          $dc_medio_contact_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['campos_busca']['dc_medio_contact_cond']; 
          $dc_tipo_cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['campos_busca']['dc_tipo_cliente']; 
          $dc_tipo_cliente_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['campos_busca']['dc_tipo_cliente_cond']; 
          $dc_nombre_clie = $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['campos_busca']['dc_nombre_clie']; 
          $dc_nombre_clie_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['campos_busca']['dc_nombre_clie_cond']; 
          $dc_num_documento = $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['campos_busca']['dc_num_documento']; 
          $dc_num_documento_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['campos_busca']['dc_num_documento_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['campos_busca']['NM_operador']; 
      } 
      if (!isset($dc_medio_contact_cond) || empty($dc_medio_contact_cond))
      {
         $dc_medio_contact_cond = "qp";
      }
      if (!isset($dc_tipo_cliente_cond) || empty($dc_tipo_cliente_cond))
      {
         $dc_tipo_cliente_cond = "qp";
      }
      if (!isset($dc_nombre_clie_cond) || empty($dc_nombre_clie_cond))
      {
         $dc_nombre_clie_cond = "qp";
      }
      if (!isset($dc_num_documento_cond) || empty($dc_num_documento_cond))
      {
         $dc_num_documento_cond = "qp";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_dc_medio_contact = (in_array($dc_medio_contact_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_dc_tipo_cliente = (in_array($dc_tipo_cliente_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_dc_nombre_clie = (in_array($dc_nombre_clie_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_dc_num_documento = (in_array($dc_num_documento_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($dc_medio_contact) || $dc_medio_contact == "")
      {
          $dc_medio_contact = "";
      }
      if (isset($dc_medio_contact) && !empty($dc_medio_contact))
      {
         $tmp_pos = strpos($dc_medio_contact, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $dc_medio_contact = substr($dc_medio_contact, 0, $tmp_pos);
         }
      }
      if (!isset($dc_tipo_cliente) || $dc_tipo_cliente == "")
      {
          $dc_tipo_cliente = "";
      }
      if (isset($dc_tipo_cliente) && !empty($dc_tipo_cliente))
      {
         $tmp_pos = strpos($dc_tipo_cliente, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $dc_tipo_cliente = substr($dc_tipo_cliente, 0, $tmp_pos);
         }
      }
      if (!isset($dc_nombre_clie) || $dc_nombre_clie == "")
      {
          $dc_nombre_clie = "";
      }
      if (isset($dc_nombre_clie) && !empty($dc_nombre_clie))
      {
         $tmp_pos = strpos($dc_nombre_clie, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $dc_nombre_clie = substr($dc_nombre_clie, 0, $tmp_pos);
         }
      }
      if (!isset($dc_num_documento) || $dc_num_documento == "")
      {
          $dc_num_documento = "";
      }
      if (isset($dc_num_documento) && !empty($dc_num_documento))
      {
         $tmp_pos = strpos($dc_num_documento, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $dc_num_documento = substr($dc_num_documento, 0, $tmp_pos);
         }
      }
?>
 <?php
...
<?php
   if (is_file("reports_admin_help.txt"))
   {
...
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['dc_medio_contact'])) ? $this->New_label['dc_medio_contact'] : "Medio Contact"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_dc_medio_contact_cond" name="dc_medio_contact_cond" onChange="nm_campos_between(document.getElementById('id_vis_dc_medio_contact'), this, 'dc_medio_contact')">
       <OPTION value="qp" <?php if ("qp" == $dc_medio_contact_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $dc_medio_contact_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $dc_medio_contact_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $dc_medio_contact_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_dc_medio_contact" <?php echo $str_hide_dc_medio_contact?> valign="top">
 ...
 $nmgp_tab_label .= "dc_medio_contact?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $dc_medio_contact_look = substr($this->Db->qstr($dc_medio_contact), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct dc.medio_contact from " . $this->Ini->nm_tabela . " where dc.medio_contact = '$dc_medio_contact_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$dc_medio_contact]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$dc_medio_contact];
      }
      else
      {
          $sAutocompValue = $dc_medio_contact;
      }
?>
<INPUT  type="text" id="SC_dc_medio_contact" name="dc_medio_contact" value="<?php echo NM_encode_input($dc_medio_contact) ?>" size=50 alt="{datatype: 'text', maxLength: 60, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_dc_medio_contact" name="dc_medio_contact_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['dc_tipo_cliente'])) ? $this->New_label['dc_tipo_cliente'] : "Tipo Cliente"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_dc_tipo_cliente_cond" name="dc_tipo_cliente_cond" onChange="nm_campos_between(document.getElementById('id_vis_dc_tipo_cliente'), this, 'dc_tipo_cliente')">
       <OPTION value="qp" <?php if ("qp" == $dc_tipo_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $dc_tipo_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $dc_tipo_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $dc_tipo_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_dc_tipo_cliente" <?php echo $str_hide_dc_tipo_cliente?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['dc_tipo_cliente'])) ? $this->New_label['dc_tipo_cliente'] : "Tipo Cliente";
 $nmgp_tab_label .= "dc_tipo_cliente?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $dc_tipo_cliente_look = substr($this->Db->qstr($dc_tipo_cliente), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct dc.tipo_cliente from " . $this->Ini->nm_tabela . " where dc.tipo_cliente = '$dc_tipo_cliente_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$dc_tipo_cliente]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$dc_tipo_cliente];
      }
      else
      {
          $sAutocompValue = $dc_tipo_cliente;
      }
?>
<INPUT  type="text" id="SC_dc_tipo_cliente" name="dc_tipo_cliente" value="<?php echo NM_encode_input($dc_tipo_cliente) ?>" size=50 alt="{datatype: 'text', maxLength: 60, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_dc_tipo_cliente" name="dc_tipo_cliente_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['dc_nombre_clie'])) ? $this->New_label['dc_nombre_clie'] : "Nombre del cliente"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_dc_nombre_clie_cond" name="dc_nombre_clie_cond" onChange="nm_campos_between(document.getElementById('id_vis_dc_nombre_clie'), this, 'dc_nombre_clie')">
       <OPTION value="qp" <?php if ("qp" == $dc_nombre_clie_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $dc_nombre_clie_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $dc_nombre_clie_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $dc_nombre_clie_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_dc_nombre_clie" <?php echo $str_hide_dc_nombre_clie?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['dc_nombre_clie'])) ? $this->New_label['dc_nombre_clie'] : "Nombre del cliente";
 $nmgp_tab_label .= "dc_nombre_clie?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $dc_nombre_clie_look = substr($this->Db->qstr($dc_nombre_clie), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct dc.nombre_clie from " . $this->Ini->nm_tabela . " where dc.nombre_clie = '$dc_nombre_clie_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$dc_nombre_clie]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$dc_nombre_clie];
      }
      else
      {
          $sAutocompValue = $dc_nombre_clie;
      }
?>
<INPUT  type="text" id="SC_dc_nombre_clie" name="dc_nombre_clie" value="<?php echo NM_encode_input($dc_nombre_clie) ?>" size=50 alt="{datatype: 'text', maxLength: 300, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_dc_nombre_clie" name="dc_nombre_clie_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['dc_num_documento'])) ? $this->New_label['dc_num_documento'] : "Documento del cliente"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_dc_num_documento_cond" name="dc_num_documento_cond" onChange="nm_campos_between(document.getElementById('id_vis_dc_num_documento'), this, 'dc_num_documento')">
       <OPTION value="qp" <?php if ("qp" == $dc_num_documento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $dc_num_documento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $dc_num_documento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $dc_num_documento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_dc_num_documento" <?php echo $str_hide_dc_num_documento?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['dc_num_documento'])) ? $this->New_label['dc_num_documento'] : "Documento del cliente";
 $nmgp_tab_label .= "dc_num_documento?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $dc_num_documento_look = substr($this->Db->qstr($dc_num_documento), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct dc.num_documento from " . $this->Ini->nm_tabela . " where dc.num_documento = '$dc_num_documento_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$dc_num_documento]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$dc_num_documento];
      }
      else
      {
          $sAutocompValue = $dc_num_documento;
      }
?>
<INPUT  type="text" id="SC_dc_num_documento" name="dc_num_documento" value="<?php echo NM_encode_input($dc_num_documento) ?>" size=50 alt="{datatype: 'text', maxLength: 60, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_dc_num_documento" name="dc_num_documento_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['reports_admin']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['reports_admin']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_dc_medio_contact'), document.F1.dc_medio_contact_cond, 'dc_medio_contact');
   document.F1.dc_medio_contact.value = "";
   document.F1.dc_medio_contact_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_dc_tipo_cliente'), document.F1.dc_tipo_cliente_cond, 'dc_tipo_cliente');
   document.F1.dc_tipo_cliente.value = "";
   document.F1.dc_tipo_cliente_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_dc_nombre_clie'), document.F1.dc_nombre_clie_cond, 'dc_nombre_clie');
   document.F1.dc_nombre_clie.value = "";
   document.F1.dc_nombre_clie_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_dc_num_documento'), document.F1.dc_num_documento_cond, 'dc_num_documento');
   document.F1.dc_num_documento.value = "";
   document.F1.dc_num_documento_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "El_Tiempo/reports_admin";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_dc_medio_contact_cond'] = 'cond';
      $tp_fields['SC_dc_medio_contact'] = 'text_aut';
      $tp_fields['id_ac_dc_medio_contact'] = 'text_aut';
      $tp_fields['SC_dc_tipo_cliente_cond'] = 'cond';
      $tp_fields['SC_dc_tipo_cliente'] = 'text_aut';
      $tp_fields['id_ac_dc_tipo_cliente'] = 'text_aut';
      $tp_fields['SC_dc_nombre_clie_cond'] = 'cond';
      $tp_fields['SC_dc_nombre_clie'] = 'text_aut';
      $tp_fields['id_ac_dc_nombre_clie'] = 'text_aut';
      $tp_fields['SC_dc_num_documento_cond'] = 'cond';
      $tp_fields['SC_dc_num_documento'] = 'text_aut';
      $tp_fields['id_ac_dc_num_documento'] = 'text_aut';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $dc_medio_contact_cond, $dc_medio_contact, $dc_medio_contact_autocomp,
             $dc_tipo_cliente_cond, $dc_tipo_cliente, $dc_tipo_cliente_autocomp,
             $dc_nombre_clie_cond, $dc_nombre_clie, $dc_nombre_clie_autocomp,
             $dc_num_documento_cond, $dc_num_documento, $dc_num_documento_autocomp, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($dc_medio_contact_autocomp) && empty($dc_medio_contact))
      {
          $dc_medio_contact = $dc_medio_contact_autocomp;
      }
      if (!empty($dc_tipo_cliente_autocomp) && empty($dc_tipo_cliente))
      {
          $dc_tipo_cliente = $dc_tipo_cliente_autocomp;
      }
      if (!empty($dc_nombre_clie_autocomp) && empty($dc_nombre_clie))
      {
          $dc_nombre_clie = $dc_nombre_clie_autocomp;
      }
      if (!empty($dc_num_documento_autocomp) && empty($dc_num_documento))
      {
          $dc_num_documento = $dc_num_documento_autocomp;
      }
      $dc_medio_contact_cond_salva = $dc_medio_contact_cond; 
      if (!isset($dc_medio_contact_input_2) || $dc_medio_contact_input_2 == "")
      {
          $dc_medio_contact_input_2 = $dc_medio_contact;
      }
      $dc_tipo_cliente_cond_salva = $dc_tipo_cliente_cond; 
      if (!isset($dc_tipo_cliente_input_2) || $dc_tipo_cliente_input_2 == "")
      {
          $dc_tipo_cliente_input_2 = $dc_tipo_cliente;
      }
      $dc_nombre_clie_cond_salva = $dc_nombre_clie_cond; 
      if (!isset($dc_nombre_clie_input_2) || $dc_nombre_clie_input_2 == "")
      {
          $dc_nombre_clie_input_2 = $dc_nombre_clie;
      }
      $dc_num_documento_cond_salva = $dc_num_documento_cond; 
      if (!isset($dc_num_documento_input_2) || $dc_num_documento_input_2 == "")
      {
          $dc_num_documento_input_2 = $dc_num_documento;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['campos_busca']['dc_medio_contact'] = $dc_medio_contact; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['campos_busca']['dc_medio_contact_cond'] = $dc_medio_contact_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['campos_busca']['dc_tipo_cliente'] = $dc_tipo_cliente; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['campos_busca']['dc_tipo_cliente_cond'] = $dc_tipo_cliente_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['campos_busca']['dc_nombre_clie'] = $dc_nombre_clie; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['campos_busca']['dc_nombre_clie_cond'] = $dc_nombre_clie_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['campos_busca']['dc_num_documento'] = $dc_num_documento; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['campos_busca']['dc_num_documento_cond'] = $dc_num_documento_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['dc_medio_contact'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['dc_medio_contact'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['dc_medio_contact'] = $dc_medio_contact;
      }
      $dc_tipo_cliente_look = substr($this->Db->qstr($dc_tipo_cliente), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct dc.tipo_cliente from " . $this->Ini->nm_tabela . " where dc.tipo_cliente = '$dc_tipo_cliente_look'"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['dc_tipo_cliente'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['dc_tipo_cliente'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['dc_tipo_cliente'] = $dc_tipo_cliente;
      }
      $dc_nombre_clie_look = substr($this->Db->qstr($dc_nombre_clie), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct dc.nombre_clie from " . $this->Ini->nm_tabela . " where dc.nombre_clie = '$dc_nombre_clie_look'"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['dc_nombre_clie'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['dc_nombre_clie'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['dc_nombre_clie'] = $dc_nombre_clie;
      }
      $dc_num_documento_look = substr($this->Db->qstr($dc_num_documento), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct dc.num_documento from " . $this->Ini->nm_tabela . " where dc.num_documento = '$dc_num_documento_look'"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['dc_num_documento'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['dc_num_documento'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['dc_num_documento'] = $dc_num_documento;
      }

      //----- $dc_medio_contact
      $this->Date_part = false;
      if (isset($dc_medio_contact) || $dc_medio_contact_cond == "nu" || $dc_medio_contact_cond == "nn" || $dc_medio_contact_cond == "ep" || $dc_medio_contact_cond == "ne")
      {
         $this->monta_condicao("dc.medio_contact", $dc_medio_contact_cond, $dc_medio_contact, "", "dc_medio_contact");
      }

      //----- $dc_tipo_cliente
      $this->Date_part = false;
      if (isset($dc_tipo_cliente) || $dc_tipo_cliente_cond == "nu" || $dc_tipo_cliente_cond == "nn" || $dc_tipo_cliente_cond == "ep" || $dc_tipo_cliente_cond == "ne")
      {
         $this->monta_condicao("dc.tipo_cliente", $dc_tipo_cliente_cond, $dc_tipo_cliente, "", "dc_tipo_cliente");
      }

      //----- $dc_nombre_clie
      $this->Date_part = false;
      if (isset($dc_nombre_clie) || $dc_nombre_clie_cond == "nu" || $dc_nombre_clie_cond == "nn" || $dc_nombre_clie_cond == "ep" || $dc_nombre_clie_cond == "ne")
      {
         $this->monta_condicao("dc.nombre_clie", $dc_nombre_clie_cond, $dc_nombre_clie, "", "dc_nombre_clie");
      }

      //----- $dc_num_documento
      $this->Date_part = false;
      if (isset($dc_num_documento) || $dc_num_documento_cond == "nu" || $dc_num_documento_cond == "nn" || $dc_num_documento_cond == "ep" || $dc_num_documento_cond == "ne")
      {
         $this->monta_condicao("dc.num_documento", $dc_num_documento_cond, $dc_num_documento, "", "dc_num_documento");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['reports_admin']['where_pesq_ant'] = $this->comando . $this->comando_fim;
