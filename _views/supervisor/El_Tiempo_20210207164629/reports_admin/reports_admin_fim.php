...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["El_Tiempo_____reports_admin"]))
   {
      unset($_SESSION['session_sec_aplicacao']["El_Tiempo_____reports_admin"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['reports_admin']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['reports_admin']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['reports_admin']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['reports_admin']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['reports_admin']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['reports_admin']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['reports_admin']['embutida_filho'] as $ind => $sc_init)
          {
