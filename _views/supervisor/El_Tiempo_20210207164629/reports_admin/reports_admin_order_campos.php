<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new reports_admin_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class reports_admin_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['dc_nombre_clie'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['dc_nombre_clie'] = "dc_nombre_clie";
       $tab_converte["dc_nombre_clie"]   = "dc_nombre_clie";
   }
   else
   {
       $tab_def_campos['dc_nombre_clie'] = "dc.nombre_clie";
       $tab_converte["dc.nombre_clie"]   = "dc_nombre_clie";
   }
   $tab_labels["dc_nombre_clie"]   = (isset($_SESSION['sc_session'][$sc_init]['reports_admin']['labels']["dc_nombre_clie"])) ? $_SESSION['sc_session'][$sc_init]['reports_admin']['labels']["dc_nombre_clie"] : "Nombre del cliente";
   $tab_ger_campos['dc_num_documento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['dc_num_documento'] = "dc_num_documento";
       $tab_converte["dc_num_documento"]   = "dc_num_documento";
   }
   else
   {
       $tab_def_campos['dc_num_documento'] = "dc.num_documento";
       $tab_converte["dc.num_documento"]   = "dc_num_documento";
   }
   $tab_labels["dc_num_documento"]   = (isset($_SESSION['sc_session'][$sc_init]['reports_admin']['labels']["dc_num_documento"])) ? $_SESSION['sc_session'][$sc_init]['reports_admin']['labels']["dc_num_documento"] : "Documento del cliente";
   $tab_ger_campos['dc_email_clie'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['dc_email_clie'] = "dc_email_clie";
       $tab_converte["dc_email_clie"]   = "dc_email_clie";
   }
   else
   {
       $tab_def_campos['dc_email_clie'] = "dc.email_clie";
       $tab_converte["dc.email_clie"]   = "dc_email_clie";
   }
   $tab_labels["dc_email_clie"]   = (isset($_SESSION['sc_session'][$sc_init]['reports_admin']['labels']["dc_email_clie"])) ? $_SESSION['sc_session'][$sc_init]['reports_admin']['labels']["dc_email_clie"] : "Correo del cliente";
   $tab_ger_campos['ds_suscripcion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ds_suscripcion'] = "ds_suscripcion";
       $tab_converte["ds_suscripcion"]   = "ds_suscripcion";
   }
   else
   {
       $tab_def_campos['ds_suscripcion'] = "ds.suscripcion";
       $tab_converte["ds.suscripcion"]   = "ds_suscripcion";
   }
   $tab_labels["ds_suscripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['reports_admin']['labels']["ds_suscripcion"])) ? $_SESSION['sc_session'][$sc_init]['reports_admin']['labels']["ds_suscripcion"] : "Suscripcion";
   $tab_ger_campos['ds_fecha_venta'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ds_fecha_venta'] = "ds_fecha_venta";
       $tab_converte["ds_fecha_venta"]   = "ds_fecha_venta";
   }
   else
   {
       $tab_def_campos['ds_fecha_venta'] = "ds.fecha_venta";
       $tab_converte["ds.fecha_venta"]   = "ds_fecha_venta";
   }
   $tab_labels["ds_fecha_venta"]   = (isset($_SESSION['sc_session'][$sc_init]['reports_admin']['labels']["ds_fecha_venta"])) ? $_SESSION['sc_session'][$sc_init]['reports_admin']['labels']["ds_fecha_venta"] : "Fecha de Venta";
   $tab_ger_campos['drs_direccion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['drs_direccion'] = "drs_direccion";
       $tab_converte["drs_direccion"]   = "drs_direccion";
   }
   else
   {
       $tab_def_campos['drs_direccion'] = "drs.direccion";
       $tab_converte["drs.direccion"]   = "drs_direccion";
   }
   $tab_labels["drs_direccion"]   = (isset($_SESSION['sc_session'][$sc_init]['reports_admin']['labels']["drs_direccion"])) ? $_SESSION['sc_session'][$sc_init]['reports_admin']['labels']["drs_direccion"] : "Direccion";
   $tab_ger_campos['u_names'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['u_names'] = "u_names";
       $tab_converte["u_names"]   = "u_names";
   }
   else
   {
       $tab_def_campos['u_names'] = "u.names";
       $tab_converte["u.names"]   = "u_names";
   }
   $tab_labels["u_names"]   = (isset($_SESSION['sc_session'][$sc_init]['reports_admin']['labels']["u_names"])) ? $_SESSION['sc_session'][$sc_init]['reports_admin']['labels']["u_names"] : "Nombre del asesor";
   $tab_ger_campos['u_surnames'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['u_surnames'] = "u_surnames";
       $tab_converte["u_surnames"]   = "u_surnames";
   }
   else
   {
       $tab_def_campos['u_surnames'] = "u.surnames";
       $tab_converte["u.surnames"]   = "u_surnames";
   }
   $tab_labels["u_surnames"]   = (isset($_SESSION['sc_session'][$sc_init]['reports_admin']['labels']["u_surnames"])) ? $_SESSION['sc_session'][$sc_init]['reports_admin']['labels']["u_surnames"] : "Apellido del asesor";
   $tab_ger_campos['u_canal'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['u_canal'] = "u_canal";
       $tab_converte["u_canal"]   = "u_canal";
   }
   else
   {
       $tab_def_campos['u_canal'] = "u.canal";
       $tab_converte["u.canal"]   = "u_canal";
   }
   $tab_labels["u_canal"]   = (isset($_SESSION['sc_session'][$sc_init]['reports_admin']['labels']["u_canal"])) ? $_SESSION['sc_session'][$sc_init]['reports_admin']['labels']["u_canal"] : "Canal";
   $tab_ger_campos['ds_fecha_autoriza'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ds_fecha_autoriza'] = "ds_fecha_autoriza";
       $tab_converte["ds_fecha_autoriza"]   = "ds_fecha_autoriza";
   }
   else
   {
       $tab_def_campos['ds_fecha_autoriza'] = "ds.fecha_autoriza";
       $tab_converte["ds.fecha_autoriza"]   = "ds_fecha_autoriza";
   }
   $tab_labels["ds_fecha_autoriza"]   = (isset($_SESSION['sc_session'][$sc_init]['reports_admin']['labels']["ds_fecha_autoriza"])) ? $_SESSION['sc_session'][$sc_init]['reports_admin']['labels']["ds_fecha_autoriza"] : "Fecha Autoriza";
   $tab_ger_campos['dc_fecha_registro'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['dc_fecha_registro'] = "dc_fecha_registro";
       $tab_converte["dc_fecha_registro"]   = "dc_fecha_registro";
   }
   else
   {
       $tab_def_campos['dc_fecha_registro'] = "dc.fecha_registro";
       $tab_converte["dc.fecha_registro"]   = "dc_fecha_registro";
   }
   $tab_labels["dc_fecha_registro"]   = (isset($_SESSION['sc_session'][$sc_init]['reports_admin']['labels']["dc_fecha_registro"])) ? $_SESSION['sc_session'][$sc_init]['reports_admin']['labels']["dc_fecha_registro"] : "Fecha Registro";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['reports_admin']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['reports_admin']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['reports_admin']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['reports_admin']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['reports_admin']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['reports_admin']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['reports_admin']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['reports_admin']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['reports_admin']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "reports_admin_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['reports_admin']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['reports_admin']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
